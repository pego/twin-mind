...
Entity extraction currently supports Python and JavaScript/TypeScript.
When available, Twin-Mind uses `oxc-parser` for JS/TS AST extraction (fallback parser otherwise).
